...
if __name__ == "__main__":
	...
	tup = ("MR1 Start", time.time())
	list_time.append(tup)
	join_result1 = obj1.execute()
	tup = ("MR1 Stop", time.time())
	list_time.append(tup)
	#print join_result1
	obj2 = MapReduceProlog(J, 5,5)
	tup = ("MR2 Start", time.time())
	list_time.append(tup)
	join_result2 = obj2.execute()
	...
	tup = ("MR3 Start", time.time())
	list_time.append(tup)
	join_result3 = obj3.execute()
	tup = ("MR3 Stop", time.time())
	list_time.append(tup)
	print("--- %s seconds ---" % (time.time() - start_time))
